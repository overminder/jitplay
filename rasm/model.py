...
class W_Pair(W_Root):
    ...
    _immutable_fields_ = ['w_car', 'w_cdr']
...
def list_to_pair(list_w):
    w_pair = w_nil
    for w_item in reversed(list_w):
        w_pair = W_Pair(w_item, w_pair)
    return w_pair

def list_to_mpair(list_w):
    w_pair = w_nil
    for w_item in reversed(list_w):
        w_pair = W_MPair(w_item, w_pair)
    return w_pair
